...
const ITEMS = [
  ...
  { q: 'Is Ember free to use?', a: "Discovering and joining events is free. The Vault — which includes exclusive recipes, live masterclasses, the Brotherhood Network, The Board certification, vetted partner deals, The Council votes, and Annual Summit access — requires a monthly (€15) or annual (€99) subscription." },
  ...
  { q: 'How do I become a Vault member?', a: "Subscribe via the Vault page. Monthly (€15) or annual (€99). Cancel anytime. Your membership activates instantly and unlocks everything — recipes, masterclasses, Brotherhood Network, The Board, Partners, The Council, and Summit access." },
