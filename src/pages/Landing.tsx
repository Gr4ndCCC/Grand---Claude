...
const VERSES = [
  ...
  { text: 'Let your light shine before others, so that they may see your good works and give glory to your Father in heaven.',          ref: 'Matthew 5:16'           },
  ...
  { text: 'Proclaim the message; be persistent whether the time is favorable or unfavorable.',                                          ref: '2 Timothy 4:2'          },
  { text: 'How beautiful are the feet of those who preach the good news!',                                                              ref: 'Romans 10:15'           },
  ...
  { text: 'The effective prayer of a righteous man can accomplish much.',                                                               ref: 'James 5:16'             },
  ...
  { text: 'But you will receive power when the Holy Spirit comes on you; and you will be my witnesses.',                                ref: 'Acts 1:8'               },
